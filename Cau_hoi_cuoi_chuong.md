...
=> Không thể tấn công từ điển với hệ thống loại thách thức- đáp ứng vì các thống tin gửi qua lại trên đường truyền thay đổi liên tục( giá trị r) nên không thể tấn công từ điển được.
